Permanently disable adding new protocols to a BittyVault on Ethereum mainnet. Owner-only operation (DEFAULT_ADMIN_ROLE).
...
Print:
```
WARNING: This action is IRREVERSIBLE. This is Ethereum mainnet.
